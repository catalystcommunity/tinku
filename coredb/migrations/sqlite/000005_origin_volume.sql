-- +goose Up
-- The SQLite dialect of ../postgres/000005_origin_volume.sql. Same table,
-- same columns; `timestamptz` becomes RFC3339 UTC text and nothing else
-- differs. Keep the two files in step.
--
