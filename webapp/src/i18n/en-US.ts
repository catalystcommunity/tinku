...
export const enUS = {
  ...
  "event.scheduleHeading": "Schedule something",
  "event.tabSingle": "One event",
  "event.tabSeries": "A repeating event",
  "event.seriesHeading": "Repeating events",
  "gathering.dangerNote": "Deleting a gathering also deletes its events. This cannot be undone.",
  "event.dangerNote": "Deleting an event cannot be undone.",
  "event.backToGathering": "Back to the gathering",
  "organization.dangerNote": "Deleting an organization cannot be undone.",
  ...
  "federation.off":
    "Federation is off on this instance. An operator switches it on with TINKU_FEDERATION_ENABLED and a federation handle. See docs/OPERATING.md.",
  ...
  "mine.calendar": "Your calendar",
  "mine.calendarNote": "The events you said you are attending.",

  // The calendar. It is read-only: scheduling happens on the gathering that
  // owns the event, which is where the permission is.
  "calendar.label": "Month",
  "calendar.previous": "Previous",
  "calendar.next": "Next",
  "calendar.today": "Today",
  "calendar.todayLabel": "today",
  "calendar.announced": "{month}: {count} events",
  "calendar.empty": "Nothing scheduled this month.",

  "picker.clear": "Change",
  "picker.noMatches": "Nothing matches.",

  "discover.viewLabel": "How to look",
  "discover.viewSearch": "Search",
  "discover.viewCalendar": "Calendar",
  "discover.mineOnly": "Only my gatherings",
  "discover.byOrganization": "From one organization",
  "discover.byOrganizationPlaceholder": "Start typing a name",

  // Moving a gathering under an organization.
  "offer.heading": "Offer this gathering to an organization",
  "offer.note": "An owner of that organization has to accept. They become an owner alongside you, and this gathering's owners join their roster. Its members stay where they are.",
  "offer.organizationLabel": "Organization",
  "offer.messageLabel": "A note for them",
  "offer.send": "Offer it",
  "offer.sent": "Offered. It is theirs to accept.",
  "offer.pending": "Offered to {organization}, waiting for an answer.",
  "offer.withdraw": "Withdraw",
  "offer.withdrawn": "Withdrawn.",
  "offer.inbox": "Gatherings offered to this organization",
  "offer.inboxEmpty": "Nothing has been offered.",
  "offer.from": "Offered by {who}",
  "offer.accept": "Accept",
  "offer.decline": "Decline",
  "offer.accepted": "Accepted. It is under this organization now.",
  ...
  "adopt.heading": "Put this gathering under an organization",
  "adopt.note": "Administrators only, and no offer is made: use it for a gathering that was started loose and belongs somewhere that already exists.",
  "adopt.action": "Adopt it",
  "adopt.done": "Done. The organization owns it now.",

  "gathering.ownerLabel": "Start it under",
  "gathering.ownerHint": "Leave this empty to own it yourself. An organization you own can own it instead.",

  // Webhooks.
  "webhook.heading": "Webhooks",
  "webhook.note": "Tinku POSTs to a URL you choose when something changes here or below here.",
  "webhook.count": "{count} of {limit}",
  "webhook.urlLabel": "URL",
  "webhook.urlHint": "https, and it has to be reachable from this server.",
  "webhook.noteLabel": "What it is for",
  "webhook.scopeLabel": "What it hears about",
  "webhook.scope.all": "Everything, events included",
  "webhook.scope.structure_only": "Only this and its gatherings, no events",
  "webhook.detailsLabel": "Send the whole record, not just a link",
  "webhook.detailsWarning": "A delivery would then carry descriptions, times, addresses and links to a server this instance does not control. It is your information to send, and the people who wrote it may not expect it to travel. Send only to an endpoint you trust.",
  "webhook.detailsAccept": "I understand what will be sent, and I accept it",
  "webhook.add": "Add a webhook",
  "webhook.added": "Added. The signing secret is below; it is shown once.",
  "webhook.secretLabel": "Signing secret",
  "webhook.secretNote": "Copy it now. It signs every delivery in the X-Tinku-Signature header, and it is never shown again.",
  "webhook.secretDone": "I have copied it",
  "webhook.remove": "Remove",
  "webhook.removeLabel": "Remove the webhook for {url}",
  "webhook.removed": "Removed.",
  "webhook.pause": "Switch off",
  "webhook.resume": "Switch on",
  "webhook.paused": "Off",
  "webhook.failing": "{count} failures in a row",
  "webhook.lastStatus": "Last answer: {status}",
  "webhook.neverSent": "Nothing sent yet",
  "webhook.empty": "No webhooks here.",
  "webhook.full": "This is as many as one gathering or organization may have.",
  "webhook.sendsDetails": "Sends the whole record",
} as const;
